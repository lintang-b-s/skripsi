...
\setstretch{0.9}
    \Procedure{findAlternativeRoutes}{$as,at: E, k: \mathbb{Z}^+$}: $Set$
        ...
        \For {$candidate \in Via$}
            \State $(\cdot, svTimeTravel, \cdot, fInfo_{sv}, bInfo_{sv}) = $\Call{TAMLBD}{$s,candidate.entry $} 
            \State $(\cdot, vtTimeTravel, \cdot, fInfo_{vt}, bInfo_{vt}) = $\Call{TAMLBD}{$candidate.exit, t $} 
            ...
            \State $edgesSV=$\Call{backtrack}{$fInfo_{sv}, bInfo_{sv}, candiate.node$}
            \State $edgesVT=$\Call{backtrack}{$fInfo_{vt}, bInfo_{vt}, candiate.node$}
