...
\Procedure{InertialFlow}{$V, U$}
    ...
    \Procedure{computeDinic}{$currPartitionGraph$}
        ...
        \For {$line \in lines$}
            \State $(sources,sinks_ \gets $\Call{SortVerticesByLineProjection}{$line, currPartitionGraph$}
...
\Procedure{Dinic}{$sources,sinks, currPartitionGraph$}
    ...
    \While{$true$}
        \If {\Call{bfsLevelGraph}{$s,t, currPartitionGraph, levels$}}
            \While{$true$}
