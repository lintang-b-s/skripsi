...
\label{IDENTIFIIKASI MASALAH DAN IDE INOVATIF}
	...
	\input{BAB_SKRIPSI/BAB2/1_PERENCANAAN_RUTE_TIME_INDEPENDENT}

        \section{Map Matching dalam Jaringan Transportasi}
	\label{Map Matching dalam Jaringan Transportasi}
	\input{BAB_SKRIPSI/BAB2/2_MAP_MATCHING}
    ...
    \input{BAB_SKRIPSI/BAB2/3_TIME_DEPENDENT_ROUTE_PLANNING.tex}

    \section{Prediksi Kecepatan Lalu Lintas}
    \label{Prediksi Kecepatan Lalu Lintas}
    \input{BAB_SKRIPSI/BAB2/4_TRAFFIC_SPEED_FORECASTING.tex}
    ...
    \input{BAB_SKRIPSI/BAB2/5_PERANGKAT_LUNAK_ROUTE_PLANNING_SUMBER_TERBUKA.tex}
...
\label{DASAR TEORI}
	...
	\input{BAB_SKRIPSI/BAB3/1_TIME_DEPENDENT_CUSTOMIZABLE_ROUTE_PLANNING_.tex}

	\section{\textit{Online Map-Matching} Menggunakan Multiple Hypothesis Technique}
	\label{multiple hypothesis technique}
		\input{BAB_SKRIPSI/BAB3/2_ONLINE_MAP_MATCHING_MHT.tex}

    \section{\textit{Traffic Forecasting} dengan Menggunakan Multivariate Time-Series Graph Neural Network}
    \label{mtgnn-section}
    \input{BAB_SKRIPSI/BAB3/3_TRAFFIC_FORECASTING_GNN.tex}
    
     \section{Pencarian Rute Alternatif dengan Metode Heuristik Admissible Paths}
    \label{alternative-routes}
    \input{BAB_SKRIPSI/BAB3/4_ALTERNATIVE_ROUTES.tex}

    \section{Mempartisi Graf Jaringan Jalan dengan Algoritma Inertial Flow}
    \label{alternative-routes}
    \input{BAB_SKRIPSI/BAB3/5_INERTIAL_FLOW.tex}

    \section{Root Mean Squared Error}
    \label{rmse}
    \input{BAB_SKRIPSI/BAB3/6_ROOT_MEAN_SQUARED_ERROR.tex}

    \section{Mean Absolute Error}
    \label{mae}
    \input{BAB_SKRIPSI/BAB3/7_MEAN_ABSOLUTE_ERROR.tex}

    \section{Akurasi}
    \label{accuracy}
    \input{BAB_SKRIPSI/BAB3/8_AKURASI.tex}

     \section{Metodologi Penelitian}
    \label{metodologi-penelitian}
    \input{BAB_SKRIPSI/BAB3/9_METODOLOGI_PENELITIAN.tex}
...
\label{JADWAL PENELITIAN}
    ...
    \label{jadwal-penelitian}
    \input{BAB_SKRIPSI/BAB4/JADWAL_PENELITIAN.tex}
